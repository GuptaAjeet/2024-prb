...
const Handler = require("../../handlers").State;
const Validate = require("../../validation").State;
...
routers.post("/coordinator-state-list", (req, res) => {
  return Handler.coordinatorStateList(req, res);
});
...
// routers.update('/delete',Validate.delete(),(req,res) => {
//     const error = Helper.validate(req,res);
//     return (error != null) ? error : Handler.delete(req,res);
// });
