...
routers.post("/financial-school-list", async (req, res) => {
  return await Handler.financilaSchoolList(req, res);
});
...
routers.post("/activity-additional-params", async (req, res) => {
  return await Handler.activityAdditionalParams(req, res);
});

routers.post("/save-additional-params", async (req, res) => {
  return await Handler.saveAdditionalParams(req, res);
});
...
routers.post("/lock-by-activity", async (req, res) => {
  return await Handler.lockByActivity(req, res);
});
