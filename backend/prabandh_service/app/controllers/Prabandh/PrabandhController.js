...
routers.get("/diet-pre-credential-list", async (req, res) => {
  return await Handler.dietPreCredentialList(req, res);
});

routers.get("/diet-pre-credential", async (req, res) => {
  return await Handler.dietPreCredential(req, res);
});

routers.post("/save-diet-pre-credential", async (req, res) => {
  return await Handler.saveDietPreCredential(req, res);
});

routers.get("/diet-progress-month-data", async (req, res) => {
  return await Handler.dietProgressMonthData(req, res);
});
...
routers.post("/diet-status", async (req, res) => {
  return await Handler.dietStatus(req, res);
});


routers.post("/approved-diet-list", async (req, res) => {
  return await Handler.approvedDietList(req, res);
});

routers.post("/diet-activity-list", async (req, res) => {
  return await Handler.dietActivityList(req, res);
});
routers.post("/diet-activity-list-dashboard", async (req, res) => {  
  return await Handler.dietActivityListDashboard(req, res);
});
