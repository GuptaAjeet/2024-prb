const Model     =   require('../../models').VolunteerType;
...
exports.index = async(req,res) =>{
    try{
        ...
        const object  = await Model.query().select(['id','volunteer_type_name','volunteer_type_status']).orderBy('volunteer_type_name').
