...
routers.use("/progress", require("../app/controllers/ProposalAfterApproval/ProposalAfterApprovalController"));
...
routers.use("/hostel", require("../app/controllers/Hostel/HostelController"));
