const Model     =   require('../../models').SchoolManagement;
...
exports.index = async(req,res) =>{
    try{
        ...
        const object  = await Model.query().select(['id','school_management_name','school_management_status']).
                                    orderBy('school_management_name').limit(request.limit).offset(request.limit*(request.page-1));
