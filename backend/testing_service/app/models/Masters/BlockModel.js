...
exports.list = async () => await DB(table).select('id', 'block_state_id', 'block_district_id', 'block_name as name').orderBy('block_name');

exports.find = async object => await DB(table).where(object).select('id', 'block_state_id', 'block_district_id', 'udise_block_code', 'block_name as name');
