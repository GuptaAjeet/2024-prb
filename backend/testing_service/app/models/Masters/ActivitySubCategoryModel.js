...
exports.all     = async () => await DB(table).select().orderBy('activity_sub_category_name');

exports.list    = async () => await DB(table).select('id','activity_category_id','activity_sub_category_name as name').orderBy('activity_sub_category_name');
