...
exports.all     = async () => await DB(table).select().orderBy('asset_sub_category_name');

exports.list    = async () => await DB(table).select('id','asset_category_id','asset_sub_category_name as name','units').orderBy('asset_sub_category_name');
