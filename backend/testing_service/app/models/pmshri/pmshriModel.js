...
exports.stateAssetForm = () =>
  DB("pmshri_state_ann_wrk_pln_bdgt_data");
...
exports.updateApprovedForm = async (object, pmshri_state_ann_wrk_pln_bdgt_data_id) =>
  await DB("prb_ann_wrk_pln_bdgt_data").where("pmshri_state_ann_wrk_pln_bdgt_data_id", pmshri_state_ann_wrk_pln_bdgt_data_id).update(object);
