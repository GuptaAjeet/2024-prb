try {
  ...
  var d_1C_4 = new ApexCharts(
    document.querySelector("#orgaincDirect"),
    d_1options2
  );
  d_1C_4.render();
      ...
      events: {
        mounted: function (ctx, config) {
          ...
          ctx.addPointAnnotation({
            ...
            customSVG: {
              SVG: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="#002147" stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg>',
              cssClass: undefined,
              offsetX: -8,
              offsetY: 5,
            },
...
*/
  var options = {
    ...
    colors: ["#002147", "#009688", "#e7515a", "#e2a03f"],
    dataLabels: {
      enabled: false,
    },
    legend: {
