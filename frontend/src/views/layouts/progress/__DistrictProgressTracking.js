...
import { Helper, API, Model, Hook } from "../../../apps";
...
const DistrictProgressTracking = () => {
    ...
    <div className="dashboard-main-content">
      <div className="dashboard-main-content-info table-container mt-3">
        <h5 className="text-center mb-2">
          <strong>
            {`${
              +initialParams?.filter?.month
                ? Model.monthsOfYear[+initialParams?.filter?.month].name
                : "Invalid month number"
            } (${store.getState().year.year})`}
          </strong>
        </h5>
          ...
          >
            <div style={{ display: "inline-block", float: "right" }}>
              <Link
                ...
                state={{ backParams: initialParams }}
              >
                {" "}
                Back
              </Link>
          ...
          >
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <span className="text-danger">Physical Quantity</span> 📦 : 0
                </td>
                <td className="bg-light">
                  <span className="text-success">Budget Approved ✅</span> : 0
                </td>
                <td>(₹ in Lakh)</td>
              </tr>
            </tbody>
...
export default DistrictProgressTracking;
