...
import { Table, Helper, Column } from "../../../apps";
  ...
  return (
    <div className="dashboard-main-content">
      ...
      <div className="col-md-12 pb-2">
        <div className="dashboard-main-content-info clear progress-tracking">
                        ...
                        return (
                          <tr key={`data_list_${m.key}`}>
                            ...
                            <td className={`${!schoolMode && "d-none"}`}>
                              {m.physical_progress_yet_to_start}
                            </td>
                            <td className={`${!schoolMode && "d-none"}`}>
                              {m.physical_progress_in_progress}1111111
                            </td>
                            <td>
                              {m.physical_progress_completed}
                              222222222222
                            </td>
                            <td>{m.financial_expenditure}3333333333</td>
                          </tr>
                        );
                      })}
