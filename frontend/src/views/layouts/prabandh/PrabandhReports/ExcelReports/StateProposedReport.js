const stateProposedExcelReport = (reportRelatedData, workSheet) => {
    ...
    workSheet.getCell('K2').value = { richText: [run1, run2, run3, run4] };
    ...
    workSheet.getCell('I3').value = { richText: [{ text: 'Proposed', font: { color: { argb: 'FFFFFFFF' }, size: 14, bold: true, name: 'Trebuchet MS' } }] }
